    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] bg-zen-cream px-6 py-20">
      ...
      >
        <div className="text-center mb-12">
          <h1 className="text-4xl font-serif italic text-zen-wood mb-4 tracking-tight">歡迎回來</h1>
          <p className="text-stone-500 text-sm font-medium uppercase tracking-widest">繼續您的茶事旅程</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-8">
          ...
          <div className="space-y-2">
            <label className="block text-xs font-medium text-stone-400 uppercase tracking-widest ml-1">密碼</label>
